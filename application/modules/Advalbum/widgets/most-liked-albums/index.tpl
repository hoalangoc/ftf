...
<div id="album_listing_most_liked<?php echo $strRand?>"></div>
<script type="text/javascript">
 function do_onload() {
    var l = document.getElementById('album_listing_most_liked<?php echo $strRand?>');
    ...
    var limit = <?php echo $this->limit?>;
     var makeRequest = new Request(
            {
                url: en4.core.baseUrl + "advalbum/ajax/most-liked-albums/number/"+ limit,
...
$album_listing_id = 'advalbum_most_liked_albums';
