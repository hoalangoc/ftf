<?php
class Advalbum_Form_Admin_Settings_Level extends Authorization_Form_Admin_Level_Abstract
{
  public function init()
  {
    ...
    if( !$this->isPublic() ) {
      ...
      $this->addElement('MultiCheckbox', 'auth_add_photo', array(
        'label' => 'Album Add Photo Options',
        'description' => 'ALBUM_FORM_ADMIN_LEVEL_AUTHADDPHOTO_DESCRIPTION',
        'multiOptions' => array(
          'everyone'            => 'Everyone',
          'owner_network'       => 'Friends and Networks',
          'owner_member_member' => 'Friends of Friends',
