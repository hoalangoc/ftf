...
UPDATE `engine4_core_modules` SET `version` = '4.02p5' WHERE `name` = 'contactimporter';
UPDATE `engine4_contactimporter_providers` SET `order` = '5' WHERE `engine4_contactimporter_providers`.`name` = 'youtube';
