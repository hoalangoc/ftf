			...
			<div class="container">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav">
						...
						<li> <span class="ynresponsive_languges">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<h4 class="heading wow flipInX" data-wow-delay="0.2s"><span><?php echo $this -> translate('How it Works?')?></span></h4>
				</div>
			</div>
			<div class="row">
							...
							<ul class="slides">
								<li>
									<div class="testimoni-box">
										...
										<div class="testimoni-text">
											<h3><?php echo $this -> translate('<span>Football </span>Talents')?></h3>
											<blockquote>
								...
								<li>
									<div class="testimoni-box">
										...
										<div class="testimoni-text">
											<h3><?php echo $this -> translate('<span>Football </span>Schools, NGOs')?></h3>
											<blockquote>
												<p><?php echo $this -> translate('
								...
								<li>
									<div class="testimoni-box">
										...
										<div class="testimoni-text">
											<h3><?php echo $this -> translate('<span>Football </span>Scouts, Agents')?></h3>
											<blockquote>
												<p><?php echo $this -> translate('
								...
								<li>
									<div class="testimoni-box">
										...
										<div class="testimoni-text">
											<h3><?php echo $this -> translate('<span>Football </span>Clubs, Universities')?></h3>
											<blockquote>
												<p>
	...
	<section id="contact" class="contain colorbg">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="divider clearfix"></div>
					<h4 class="heading wow flipInX" data-wow-delay="0.2s"><span><?php echo $this -> translate('Contact us')?></span></h4>
				</div>
			</div>
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
